...
export class DefeatEndingScene extends Phaser.Scene {
    constructor() {
        ...
        this.dialogues = [
            ...
            {
                text: "누구나 공통적으로, 사람들은 자신과 다른 비교 대상을 찾아 타인과 다른 점을 가진 자신들을 정당화하거나, 심한 경우엔 우상화하곤 하지. 자기중심적으로 말이야.",
                character: 'clonihil_face_future',
                name: '클로니 힐',
                background: 'asexual_dispute',
            },
            ...
            {
                text: "성별도 그렇고, 모든 사람들은 자신과 다른 점을 가진 타인들을 공감하지 못해. 그렇기에 인간 사회에서 갈등과 차별은 끊이질 않는 거야.",
                character: 'clonihil_face_future',
                name: '클로니 힐',
                background: 'asexual_dispute',
            },
            ...
            {
                text: "아, 오프니온은 어떻게 됐냐고? 당연히 죽었지. 뭐, 그 친구가 살아있길 기대하기라도 한 거야?",
                character: 'clonihil_face_future',
                name: '클로니 힐',
                background: 'clonihil_house',
            },
