export class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('bomb', `${basePath}/assets/images/bomb.png`);
        ...
        this.load.image('finalBossMeet', `${basePath}/assets/images/finalBossMeet.png`);
        ...
        this.load.image('openion_face_dead', `${basePath}/assets/images/openion_face_dead.png`);
        ...
        this.load.image('openion2_face_future', `${basePath}/assets/images/openion2_face_future.png`);
        ...
        this.load.image('murderscene_final', `${basePath}/assets/images/murderscene_final.png`);
        this.load.image('murderscene_final2', `${basePath}/assets/images/murderscene_final2.png`);
        this.load.image('murderscene_final3', `${basePath}/assets/images/murderscene_final3.png`);
        this.load.image('murderscene_final_noise', `${basePath}/assets/images/murderscene_final_noise.png`);
        ...
        this.load.image('clonihil_lab_recall', `${basePath}/assets/images/clonihil_lab_recall.png`);
        ...
        this.load.image('trueEnding_digital', `${basePath}/assets/images/trueEnding_digital.png`);
        this.load.image('trueEnding_future', `${basePath}/assets/images/trueEnding_future.png`);
    }
